  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-0 w-[80%] h-[80%] rounded-full white__gradient z-[1]"></div>
        <div className="absolute right-0 bottom-20 w-[50%] h-[55%] blue__gradient z-[0]"></div>
      </div>
